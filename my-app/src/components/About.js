...
export default function About() {
    ...
    // const [myStyleDark, setMyStyleState] = useState(myStyleDark);
    // const [myStyle, set] = useState(myStyleDark);
    // const [myStyle, setMyStyleState] = useState(myStyle2Dark);
    // const [myStyle, setMyStyleState] = useState(myStyleWhite);
    // const [myStyle, setMyStyleState] = useState(myStyle2White);
